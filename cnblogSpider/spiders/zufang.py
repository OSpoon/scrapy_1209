...
from cnblogSpider.items import RenthousescrapyItem
...
class ZufangSpider(scrapy.Spider):
    ...
    def start_requests(self):
        ...
        return [scrapy.FormRequest(start_url, headers=self.headers,callback=self.head_url_callback,dont_filter=True)]
